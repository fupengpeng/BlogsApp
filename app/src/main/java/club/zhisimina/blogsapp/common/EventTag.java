...
/**
 * @description  EventBus标签
 * @author  fupengpeng
 * @date  2018/4/11 0011 16:53
 * xxxx.xx.xxxx
 * 类  作用 标签
 * 1001:                          客户账单
 * 1002:                          消费账单详情
...
public class EventTag {
    ...
    public class getMessage{
         ...
         * 充值/升级账单列表
         */
        public static final int CLIENT_RECHARGE_BILL_GET_MESSAGE=1001040002;
        /**
         * 套餐账单列表
         */
        public static final int CLIENT_SET_MEAL_BILL_GET_MESSAGE=1001040003;
        /**
         * 消费账单列表搜索无数据
         */
         ...
         * 充值/升级账单列表搜索无数据
         */
        public static final int CLIENT_RECHARGE_BILL_GET_PARTICULARS=1001020002;
        /**
         * 套餐账单列表搜索无数据
         */
        public static final int CLIENT_SET_MEAL_GET_PARTICULARS=1001020002;
        /**
         * 会员资料类型
         */
    ...
    public class LogInAgain{
        public static final int LOGINAGAIN=1000000000;
    }
}
