package club.zhisimina.blogsapp.model.impl;
...
import club.zhisimina.blogsapp.application.MyApplication;
import club.zhisimina.blogsapp.common.Consts;
import club.zhisimina.blogsapp.common.DataEvent;
import club.zhisimina.blogsapp.common.EventTag;
import club.zhisimina.blogsapp.common.ObjectCallBack;
import club.zhisimina.blogsapp.entity.LoginResponseData;
import club.zhisimina.blogsapp.entity.response.LoginResponse;
import club.zhisimina.blogsapp.entity.response.ReturnStringResponse;
import club.zhisimina.blogsapp.model.interf.IUserModel;
import club.zhisimina.blogsapp.util.BitmapUtils;
import club.zhisimina.blogsapp.util.DateUtils;
import club.zhisimina.blogsapp.util.LogUtils;
import club.zhisimina.blogsapp.util.MD5Util;
import club.zhisimina.blogsapp.util.SPUtils;
            ...
            public void onSucceed(int what, Response<String> response) {
                ...
                if (loginResponse.getCode() == 0) { // 成功
                    ...
                    if ("请重新登录".equals(e.getMessage())){
                        EventBus.getDefault().post(new DataEvent(EventTag.LogInAgain.LOGINAGAIN));
                    }
                }
            }
